...
# Set subscription
$subscriptionId = "d7cc508e-d2cc-46d7-8185-5b4cb24827bb" #  GUID of target Azure subscription
Get-AzSubscription -Subscriptionid $subscriptionId | Select-AzSubscription

# Create resource group
$resGroupName = "fa-digitalgw-03" # resource group name
...
$apimServiceName = "skalingclouds-apim"                 # API Management service instance name (.azure-api.net suffix will be added so has to be globally unique)
$apimOrganization = "skalingclouds"          # organization name
$apimAdminEmail = "chris.skaling@microsoft.com" # administrator's email address
